...
function [out] = f(X, kx, ky, Mu, Cm)
    x = X(1)
    y = X(2)
    out =  (Mu*( kx*kx + ky*ky ) + Cm )*sin(x*kx).*cos(y*ky) 
 endfunction
//--------------------------------
function [Mu, Cm] = Composite_Mat(Xg)
    Mu     = 1.0  
    Cm     = 2.0
endfunction
//--------------------------------
    ...
    for e =1:Ne
        ...
        for gp = 1:Ng
            ...
            for k=1:Nve
                ...
                Be_k        = f(Xg, kx, ky, C_Mu,C_Cm)*Phi_is ;
                ...
                for kp = 1:Nve
                    ...
                    Ae_k_kp    = C_Mu*sum(GradPhi_is.*GradPhi_js)...
                               + C_Cm*Phi_is*Phi_js;
